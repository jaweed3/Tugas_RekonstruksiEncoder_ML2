...
\author{Nama: [Nama Lengkap] \\ NIM: [NIM]}
\date{}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.85\textwidth]{results/training_loss_comparison.png}
\caption{Perbandingan training loss antar latent dimension}
\end{figure}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.9\textwidth]{results/reconstruction_comparison.png}
...
\midrule
2 & [0.0XXX] & [cukup buram, detail tepi hilang] & [representasi terlalu terbatas] \\
8 & [0.0XXX] & [cukup jelas, sedikit blur] & [keseimbangan kompresi dan detail] \\
32 & [0.0XXX] & [lebih tajam, detail terjaga] & [rekonstruksi paling baik] \\
\bottomrule
\end{tabular}
\end{table}
...
[Gambar screenshot terminal akan ditempatkan di sini setelah proses training dan pengujian selesai.]
